$(document).ready(function() {
    ...
    $('#mainDropdown .js-example-basic-single').on('change', function() {
        ...
        const $subDropdown = $('#subCategory');
        const $subDropdownContainer = $('#subDropdown');
        const $fuelQuantityInput = $('#fuelQuantityInput');
        const $waterQuantityInput = $('#waterQuantityInput');
        const $waterTotalCostContainer = $('#waterTotalCostContainer');
        const $perGallonCostContainer = $('#perGallonCostContainer');
